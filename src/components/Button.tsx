...
const styles = {
  ...
  "primary-invert":
    "text-blue-500 bg-gradient-to-r bg-white focus:ring-4 focus:outline-none focus:ring-white-300 dark:focus:ring-white-800 shadow-lg shadow-white-500/50 dark:shadow-lg dark:shadow-white-800/80 font-medium rounded-lg text-sm text-center",
};
